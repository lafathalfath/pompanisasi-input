...
<div class="container mt-4">
    ...
    <div class="row info-section">
        ...
        <div class="col-md-3">
            <h5>Kelompok Tani</h5>
            <p>{{ $ref_dimanfaatkan->nama_poktan }}</p>
        </div>
        <div class="col-md-3">
            <h5>Luas Lahan (Ha)</h5>
            <p>{{ $ref_dimanfaatkan->luas_lahan }}</p>
        </div>
    </div>
    ...
    <div class="row info-section">
        <div class="col-md-3">
            ...
            <p>{{ $ref_dimanfaatkan->pompa_3_inch }}</p>
        </div>
        <div class="col-md-3">
            <h5>Pompa Refocusing 4 Inch (unit)</h5>
            <p>{{ $ref_dimanfaatkan->pompa_4_inch }}</p>
        </div>
        <div class="col-md-3">
            <h5>Pompa Refocusing 6 Inch (unit)</h5>
            <p>{{ $ref_dimanfaatkan->pompa_6_inch }}</p>
        </div>
        <div class="col-md-3">
            <h5>No HP Poktan</h5>
    ...
    <div class="row image-section">
        <div class="col-12">
            ...
            <img src="{{ $ref_dimanfaatkan->url_gambar }}" alt="Dokumentasi Foto">
        </div>
    </div>
</div>
@endsection