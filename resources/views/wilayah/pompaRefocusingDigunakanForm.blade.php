    ...
    <form action="#" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                <label for="pumparefDigunakanprov">Provinsi</label>
                <input type="text" name="pompa_ref_digunakan_prov" class="form-control" id="pumparefDigunakanprov" placeholder="Prov" required>
            </div>
            <div class="form-group col-md-4">
