    ...
    <form action="{{ route('kecamatan.abt.usulan.store') }}" method="POST">
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <input type="number" name="pompa_3_inch" class="form-control" id="pilihan_spesifikasi_pompa_3inch" placeholder="Unit" required oninput="updateJumlahUsulan()">
            </div>
            <div class="form-group col-md-4">
                <label for="pilihan_spesifikasi_pompa_4inch">Pompa 4 Inch</label>
                <input type="number" name="pompa_4_inch" class="form-control" id="pilihan_spesifikasi_pompa_4inch" placeholder="Unit" required oninput="updateJumlahUsulan()">
            </div>
            <div class="form-group col-md-4">
                <label for="pilihan_spesifikasi_pompa_6inch">Pompa 6 Inch</label>
                <input type="number" name="pompa_6_inch" class="form-control" id="pilihan_spesifikasi_pompa_6inch" placeholder="Unit" required oninput="updateJumlahUsulan()">
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <input type="number" name="total_unit" class="form-control" id="pumpaABTUsulanJumlah" placeholder="Jumlah" readonly>
            </div>
            <div class="form-group col-md-4">
