...
<div class="d-flex flex-col justify-content-center">
    <div>
        <div>
            <a href="{{ route('kecamatan.refocusing.diterima.input') }}" type="submit" class="btn btn-success">Input Data</a>
            <a href="{{ url('/export-pompa-ref-diterima') }}" class="btn btn-secondary"><i class="fa fa-download"></i> Excel</a>
