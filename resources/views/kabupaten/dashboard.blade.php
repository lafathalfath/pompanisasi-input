    ...
    <table class="table table-bordered table-custom" style="width: 45%; margin-right: 20px; display: inline-table;">
        ...
        <tbody>
            <tr>
                ...
                <td style="padding: 10px 20px;" id="ref_diterima">{{ $pompanisasinisasi }}</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">Refocusing Digunakan</td>
                <td style="padding: 10px 20px;" id="ref_dimanfaatkan">{{ $pompanisasinisasi }}</td>
            </tr>
        </tbody>
    </table>
    <table class="table table-bordered table-custom" style="width: 45%;">
        ...
        <tbody>
            <tr>
                ...
                <td style="padding: 10px 20px;" id="abt_usulan">{{ $pompanisasinisasi }}</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">ABT Diterima</td>
                <td style="padding: 10px 20px;" id="abt_diterima">{{ $pompanisasinisasi }}</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">ABT Digunakan</td>
                <td style="padding: 10px 20px;" id="abt_dimanfaatkan">{{ $pompanisasinisasi }}</td>
            </tr>
        </tbody>
    </table>
    <table class="table table-bordered table-custom" style="width: 45%;">
